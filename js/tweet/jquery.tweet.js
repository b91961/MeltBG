(function($) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      username: ["MeltBG"],                // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
      ...
      twitter_url: "twitter.com/MeltBG",               // [string]   custom twitter url, if any (apigee, etc.)
